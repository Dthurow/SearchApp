...
namespace SearchApp.Data
{
    public static class SearchAppDbInitializer
    {
        public static void Initialize(SearchAppContext context)
        {
            ...
            {
                new Person{FirstName="Carson",LastName="Alexander",Age=10, PersonPictureFileName="alexander.png"},
                new Person{FirstName="Meredith",LastName="Alonso",Age=20, PersonPictureFileName="alonso.png"},
                new Person{FirstName="Arturo",LastName="Anand",Age=80, PersonPictureFileName="anand.png"},
                new Person{FirstName="Gytis",LastName="Barzdukas",Age=18, PersonPictureFileName="barzdukas.png"},
                new Person{FirstName="Yan",LastName="Li",Age=50, PersonPictureFileName="li.png"},
                new Person{FirstName="Peggy",LastName="Justice",Age=45, PersonPictureFileName="justice.png"},
                new Person{FirstName="Laura",LastName="Norman",Age=13, PersonPictureFileName="norman.png"},
                new Person{FirstName="Nino",LastName="Olivetto",Age=26, PersonPictureFileName="olivetto.png"}
            };
